...
<div class="container clearfix">
    ...
    <label for="myFile" class="custom-file-upload">上传文件</label>
    <input type="file" id="myFile" class="hidden-file-input" style="display: none;">
    <!-- <img id="showImg" src="" alt="上传的图片"> -->
    <form  method="post"  >
    ...
    <%
        ...
        Person person = DBUtil.getOneContact(ct_id, 1);
        if (person != null) {
            // 处理ct_id
